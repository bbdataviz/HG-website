var svg1_4 = d3.select("#svg-pos1-4"),
    ...
    d3.csv("https://raw.githubusercontent.com/bbdataviz/HG-D3/main/NV_symptoms%2B%2By.csv", type, function(error, data) {
      ...
      y.domain([100,0])
         .range([0,height]);
      //*/
      z1_4.domain(sources.map(function(c) { return c.id; }));
      ...
      source.append("path")
          .attr("d", function(d) { console.log(area1_4(d.values)); return area1_4(d.values); })
          .style("fill", function(d) { return z1_4(d.id); });
