var svg1_2 = d3.select("#svg-pos1-2"),
    ...
    d3.csv("https://raw.githubusercontent.com/bbdataviz/HG-D3/main/NV_symptoms%2B%2By.csv", type, function(error, data) {
      ...
      z1_2.domain(sources.map(function(c) { return c.id; }));

      var source = g1_2.selectAll(".area")
          .data(sources)
          .enter().append("g")
          .attr("class", function(d) { return `area ${d.id}`; })
      /*
      source.append("path")
          .attr("d", function(d) { console.log(area1_1(d.values)); return area1_1(d.values); })
          .style("fill", function(d) { return z1_1(d.id); });
      */
      g1_2.append("g")
